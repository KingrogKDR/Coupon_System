    ...
    <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl m-4">
      <div className="p-8">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-800 mb-4">Get Your Discount Coupon</h1>
          <p className="text-gray-600 mb-6">
            Click the button below to claim a special discount coupon.
            Note: You can only claim one coupon per device within a 24-hour period.
          </p>
          ...
          {coupon && (
            <div className="mt-6 bg-gray-100 p-6 rounded-lg border-2 border-dashed border-gray-300">
              <div className="text-center">
                <h2 className="text-xl font-bold text-gray-800 mb-2">Your Coupon</h2>
                ...
                <p className="text-gray-800 font-semibold mb-2">Discount: ${coupon.discountAmount}</p>
